...
void ReaderMG1::readIndices(std::shared_ptr<ICTMRStream> stream, std::shared_ptr<draco::Int32Array> indices)
{
...
void ReaderMG1::readVertices(std::shared_ptr<ICTMRStream> stream, std::shared_ptr<draco::Float32Array> vertices)
{
...
void ReaderMG1::readNormals(std::shared_ptr<ICTMRStream> stream, std::shared_ptr<draco::Float32Array> normals)
{
