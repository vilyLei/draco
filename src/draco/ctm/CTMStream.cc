...
CTMStream::CTMStream(std::shared_ptr<draco::Uint8Array> pdata)
{
    data = pdata;
    offset = 0;
...
std::string CTMStream::decodeUint8Arr(std::shared_ptr<draco::Uint8Array> pu8array)
{
...
std::shared_ptr<draco::Int32Array> CTMStream::readArrayInt32(std::shared_ptr<draco::Int32Array> array)
{
...
std::shared_ptr<draco::Float32Array> CTMStream::readArrayFloat32(std::shared_ptr<draco::Float32Array>  array)
{
    Int32 i   = 0,
          len = array->getLength();
