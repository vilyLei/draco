...
bool LZMADecoder::setDictionarySize(Int32 dictionarySize)
{
    if (dictionarySize < 0)
    {
        return false;
...
bool LZMADecoder::setLcLpPb(Uint32 lc, Uint32 lp, Uint32 pb)
{
...
bool LZMADecoder::decode(std::shared_ptr<ICTMRStream> inStream,
...
bool LZMADecoder::setDecoderProperties(std::shared_ptr<ICTMRStream> properties)
{
...
{
    std::shared_ptr<LZMADecoder> decoder = std::make_shared<LZMADecoder>();
